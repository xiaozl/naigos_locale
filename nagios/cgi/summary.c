...
int main(int argc, char **argv) {
	...
	if(display_header == TRUE) {
		...
		if(generate_report == TRUE) {
			...
			if(display_type == REPORT_TOP_ALERTS)
				...
				printf(_("Alert Totals"));
			else
				printf(_("Most Recent Alerts"));

			if(show_all_hostgroups == FALSE)
				printf(" %s '%s'", _("For Hostgroup"),target_hostgroup_name);
			else if(show_all_servicegroups == FALSE)
				printf(" %s '%s'", _("For Servicegroup"),target_servicegroup_name);
			else if(show_all_hosts == FALSE)
				printf(" %s '%s'", _("For Host"),target_host_name);
		...
		if(generate_report == TRUE) {
			...
			printf("<tr>\n");
			printf("<td valign=top align=left class='optBoxTitle' colspan=2>%s:</td>\n",_("Duration"));
			printf("</tr>\n");

			printf("<tr>\n");
			printf("<td valign=top align=left class='optBoxItem'>%s:</td>\n",_("Alert Types"));
			printf("<td valign=top align=left class='optBoxValue'>\n");
			if(alert_types & AE_HOST_ALERT)
				printf(_("Host"));
			if(alert_types & AE_SERVICE_ALERT)
				printf("%s%s", (alert_types & AE_HOST_ALERT) ? " &amp; " : "",_("Service"));
			printf(" %s</td>\n",_("Alerts"));
			printf("</tr>\n");
			...
			if(host_states & AE_HOST_DOWN) {
				printf("%s%s", (x == 1) ? ", " : "",_("Down"));
				x = 1;
				}
			if(host_states & AE_HOST_UNREACHABLE)
				printf("%s%s", (x == 1) ? ", " : "",_("Unreachable"));
			if(x == 0)
				printf(_("None"));
			printf("</td>\n");
			printf("</tr>\n");
			...
			if(service_states & AE_SERVICE_WARNING) {
				printf("%s%s", (x == 1) ? ", " : "",_("Warning"));
				x = 1;
				}
			if(service_states & AE_SERVICE_UNKNOWN) {
				printf("%s%s", (x == 1) ? ", " : "",_("Unknown"));
				x = 1;
				}
			if(service_states & AE_SERVICE_CRITICAL)
				printf("%s%s", (x == 1) ? ", " : "",_("Critical"));
			if(x == 0)
				printf(_("None"));
			printf("</td>\n");
			printf("</tr>\n");
			...
			printf("<input type='submit' name='btnSubmit' value='%s'>\n",_("Generate New Report"));
			printf("</form>\n");
			printf("</td>\n");
			printf("</tr>\n");
	...
	/* ask user for report options */
		...
		printf("<DIV ALIGN=CENTER CLASS='dateSelectTitle'>%s:</DIV>\n",_("Standard Reports"));
		...
		printf("<option value=%d>%s\n", SREPORT_RECENT_ALERTS,_("25 Most Recent Hard Alerts"));
		printf("<option value=%d>%s\n", SREPORT_RECENT_HOST_ALERTS,_("25 Most Recent Hard Host Alerts"));
		printf("<option value=%d>%s\n", SREPORT_RECENT_SERVICE_ALERTS,_("25 Most Recent Hard Service Alerts"));
		printf("<option value=%d>%s\n", SREPORT_TOP_HOST_ALERTS,_("Top 25 Hard Host Alert Producers"));
		printf("<option value=%d>%s\n", SREPORT_TOP_SERVICE_ALERTS,_("Top 25 Hard Service Alert Producers"));
		printf("</select>\n");
		printf("</td></tr>\n");

		printf("<tr><td></td><td align=left class='dateSelectItem'><input type='submit' value='%s'></td></tr>\n",_("Create Summary Report!"));
		...
		printf("<option value=%d>%s\n", REPORT_RECENT_ALERTS,_("Most Recent Alerts"));
		printf("<option value=%d>%s\n", REPORT_ALERT_TOTALS,_("Alert Totals"));
		printf("<option value=%d>%s\n", REPORT_HOSTGROUP_ALERT_TOTALS,_("Alert Totals By Hostgroup"));
		printf("<option value=%d>%s\n", REPORT_HOST_ALERT_TOTALS,_("Alert Totals By Host"));
		printf("<option value=%d>%s\n", REPORT_SERVICEGROUP_ALERT_TOTALS,_("Alert Totals By Servicegroup"));
		printf("<option value=%d>%s\n", REPORT_SERVICE_ALERT_TOTALS,_("Alert Totals By Service"));
		printf("<option value=%d>%s\n", REPORT_TOP_ALERTS,_("Top Alert Producers"));
		printf("</select>\n");
		printf("</td></tr>\n");
		...
		printf("<option value=%d %s>%s\n", AE_HOST_ALERT + AE_SERVICE_ALERT, (alert_types == AE_HOST_ALERT + AE_SERVICE_ALERT) ? "SELECTED" : "",_("Host and Service Alerts"));
		printf("<option value=%d %s>%s\n", AE_HOST_ALERT, (alert_types == AE_HOST_ALERT) ? "SELECTED" : "",_("Host Alerts"));
		printf("<option value=%d %s>%s\n", AE_SERVICE_ALERT, (alert_types == AE_SERVICE_ALERT) ? "SELECTED" : "",_("Service Alerts"));
		printf("</select>\n");
		printf("</td></tr>\n");
		...
		printf("<option value=%d %s>%s\n", AE_HARD_STATE + AE_SOFT_STATE, (state_types == AE_HARD_STATE + AE_SOFT_STATE) ? "SELECTED" : "",_("Hard and Soft States"));
		printf("<option value=%d %s>%s\n", AE_HARD_STATE, (state_types == AE_HARD_STATE) ? "SELECTED" : "",_("Hard States"));
		printf("<option value=%d %s>%s\n", AE_SOFT_STATE, (state_types == AE_SOFT_STATE) ? "SELECTED" : "",_("Soft States"));
		printf("</select>\n");
		printf("</td></tr>\n");
		...
		printf("<option value=%d>%s\n", AE_HOST_UP + AE_HOST_DOWN + AE_HOST_UNREACHABLE,_("All Host States"));
		printf("<option value=%d>%s\n", AE_HOST_DOWN + AE_HOST_UNREACHABLE,_("Host Problem States"));
		printf("<option value=%d>%s\n", AE_HOST_UP,_("Host Up States"));
		printf("<option value=%d>%s\n", AE_HOST_DOWN,_("Host Down States"));
		printf("<option value=%d>%s\n", AE_HOST_UNREACHABLE,_("Host Unreachable States"));
		printf("</select>\n");
		printf("</td></tr>\n");
		...
		printf("<option value=%d>%s\n", AE_SERVICE_OK + AE_SERVICE_WARNING + AE_SERVICE_UNKNOWN + AE_SERVICE_CRITICAL,_("All Service States"));
		printf("<option value=%d>%s\n", AE_SERVICE_WARNING + AE_SERVICE_UNKNOWN + AE_SERVICE_CRITICAL,_("Service Problem States"));
		printf("<option value=%d>%s\n", AE_SERVICE_OK,_("Service Ok States"));
		printf("<option value=%d>%s\n", AE_SERVICE_WARNING,_("Service Warning States"));
		printf("<option value=%d>%s\n", AE_SERVICE_UNKNOWN,_("Service Unknown States"));
		printf("<option value=%d>%s\n", AE_SERVICE_CRITICAL,_("Service Critical States"));
		printf("</select>\n");
		printf("</td></tr>\n");
...
#ifdef DEBUG
	if(event_type == AE_HOST_ALERT)
		printf("%s (%s) @ %lu<BR>\n",_("Adding host alert"), host_name, (unsigned long)time_stamp);
	else
		printf("%s (%s/%s) @ %lu<BR>\n", _("Adding service alert"),host_name, svc_description, (unsigned long)time_stamp);
#endif
...
void display_alert_totals(void) {
	...
	printf("<DIV ALIGN=CENTER>\n");
	printf("<DIV ALIGN=CENTER CLASS='dataSubTitle'>%s</DIV>\n",_("Overall Totals"));
	printf("<BR>\n");
	...
	if(alert_types & AE_HOST_ALERT) {
		...
		printf("<DIV ALIGN=CENTER>\n");
		printf("<TABLE BORDER=0 CLASS='data'>\n");
		printf("<TR><TH CLASS='data'>%s</TH><TH CLASS='data'>%s</TH><TH CLASS='data'>%s</TH><TH CLASS='data'>%s</TH></TR>\n",_("State"),_("Soft Alerts"),_("Hard Alerts"),_("Total Alerts"));

		printf("<TR CLASS='dataOdd'><TD CLASS='hostUP'>%s</TD><TD CLASS='dataOdd'>%d</TD><TD CLASS='dataOdd'>%d</TD><TD CLASS='dataOdd'>%d</TD></TR>\n", _("UP"),soft_host_up_alerts, hard_host_up_alerts, soft_host_up_alerts + hard_host_up_alerts);
		printf("<TR CLASS='dataEven'><TD CLASS='hostDOWN'>%s</TD><TD CLASS='dataEven'>%d</TD><TD CLASS='dataEven'>%d</TD><TD CLASS='dataEven'>%d</TD></TR>\n", _("DOWN"),soft_host_down_alerts, hard_host_down_alerts, soft_host_down_alerts + hard_host_down_alerts);
		printf("<TR CLASS='dataOdd'><TD CLASS='hostUNREACHABLE'>%s</TD><TD CLASS='dataOdd'>%d</TD><TD CLASS='dataOdd'>%d</TD><TD CLASS='dataOdd'>%d</TD></TR>\n", _("UNREACHABLE"),soft_host_unreachable_alerts, hard_host_unreachable_alerts, soft_host_unreachable_alerts + hard_host_unreachable_alerts);
		printf("<TR CLASS='dataEven'><TD CLASS='dataEven'>%s</TD><TD CLASS='dataEven'>%d</TD><TD CLASS='dataEven'>%d</TD><TD CLASS='dataEven'><B>%d</B></TD></TR>\n", _("All States"),soft_host_up_alerts + soft_host_down_alerts + soft_host_unreachable_alerts, hard_host_up_alerts + hard_host_down_alerts + hard_host_unreachable_alerts, soft_host_up_alerts + hard_host_up_alerts + soft_host_down_alerts + hard_host_down_alerts + soft_host_unreachable_alerts + hard_host_unreachable_alerts);
	...
	if(alert_types & AE_SERVICE_ALERT) {
		...
		printf("<TR CLASS='dataOdd'><TD CLASS='serviceOK'>%s</TD><TD CLASS='dataOdd'>%d</TD><TD CLASS='dataOdd'>%d</TD><TD CLASS='dataOdd'>%d</TD></TR>\n", _("OK"),soft_service_ok_alerts, hard_service_ok_alerts, soft_service_ok_alerts + hard_service_ok_alerts);
		printf("<TR CLASS='dataEven'><TD CLASS='serviceWARNING'>%s</TD><TD CLASS='dataEven'>%d</TD><TD CLASS='dataEven'>%d</TD><TD CLASS='dataEven'>%d</TD></TR>\n", _("WARNING"),soft_service_warning_alerts, hard_service_warning_alerts, soft_service_warning_alerts + hard_service_warning_alerts);
		printf("<TR CLASS='dataOdd'><TD CLASS='serviceUNKNOWN'>%s</TD><TD CLASS='dataOdd'>%d</TD><TD CLASS='dataOdd'>%d</TD><TD CLASS='dataOdd'>%d</TD></TR>\n", _("UNKNOWN"),soft_service_unknown_alerts, hard_service_unknown_alerts, soft_service_unknown_alerts + hard_service_unknown_alerts);
		printf("<TR CLASS='dataEven'><TD CLASS='serviceCRITICAL'>%s</TD><TD CLASS='dataEven'>%d</TD><TD CLASS='dataEven'>%d</TD><TD CLASS='dataEven'>%d</TD></TR>\n", _("CRITICAL"),soft_service_critical_alerts, hard_service_critical_alerts, soft_service_critical_alerts + hard_service_critical_alerts);
		printf("<TR CLASS='dataOdd'><TD CLASS='dataOdd'>%s</TD><TD CLASS='dataOdd'>%d</TD><TD CLASS='dataOdd'>%d</TD><TD CLASS='dataOdd'><B>%d</B></TD></TR>\n", _("All States"),soft_service_ok_alerts + soft_service_warning_alerts + soft_service_unknown_alerts + soft_service_critical_alerts, hard_service_ok_alerts + hard_service_warning_alerts + hard_service_unknown_alerts + hard_service_critical_alerts, soft_service_ok_alerts + soft_service_warning_alerts + soft_service_unknown_alerts + soft_service_critical_alerts + hard_service_ok_alerts + hard_service_warning_alerts + hard_service_unknown_alerts + hard_service_critical_alerts);
...
void display_specific_hostgroup_alert_totals(hostgroup *grp) {
	...
	printf("<TR><TD COLSPAN=2 ALIGN=CENTER CLASS='dataSubTitle'>%s '%s' (%s)</TD></TR>\n", _("Hostgroup"),grp->group_name, grp->alias);
...
void display_specific_host_alert_totals(host *hst) {
	...
	if(alert_types & AE_HOST_ALERT) {
		...
		printf("<DIV ALIGN=CENTER>\n");
		printf("<TABLE BORDER=0 CLASS='data'>\n");
		printf("<TR><TH CLASS='data'>%s</TH><TH CLASS='data'>%s</TH><TH CLASS='data'>%s</TH><TH CLASS='data'>%s</TH></TR>\n",_("State"),_("Soft Alerts"),_("Soft Alerts"),_("Total Alerts"));
...
void display_specific_servicegroup_alert_totals(servicegroup *grp) {
	...
	printf("<TR><TD COLSPAN=2 ALIGN=CENTER CLASS='dataSubTitle'>%s '%s' (%s)</TD></TR>\n",_("Servicegroup"), grp->group_name, grp->alias);

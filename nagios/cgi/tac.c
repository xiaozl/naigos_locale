...
int main(void) {
	...
	if(display_header == TRUE) {
		...
		display_info_table(_("Tactical Status Overview"), TRUE, &current_authdata);
		printf("</td>\n");
	...
	if(hosts_unreachable_unacknowledged > 0 && host_unreachable_sound != NULL)
		...
		sound = normal_sound;
	if(sound != NULL) {
		printf("<object type=\"audio/x-wav\" data=\"\/media%s%s\" height=\"-\" width=\"0\">", url_media_path, sound);
		printf("<param name=\"filename\" value=\"\/media%s%s\">", url_media_path, sound);
...
void document_header(int use_stylesheet) {
	...
	printf("<TITLE>\n");
	printf("%s",_("Nagios Tactical Monitoring Overview\n"));
	printf("</TITLE>\n");
...
void display_tac_overview(void) {
	...
	display_info_table(_("Tactical Monitoring Overview"), TRUE, &current_authdata);
	
	printf("<TABLE BORDER=1 CELLPADDING=0 CELLSPACING=0 CLASS='linkBox'>\n");
		printf("<TR><TD CLASS='linkBox'>\n");
		printf("<a href='javascript:window.print()' target='_self'>%s</a>",_("print current page"));
		printf("</TD></TR>\n");
		printf("</TABLE>\n");
	...
	printf("<tr>\n");
	printf("<td class='perfTitle'>&nbsp;<a href='%s?type=%d' class='perfTitle'>%s</a></td>\n", EXTINFO_CGI, DISPLAY_PERFORMANCE,_("Monitoring Performance"));
	printf("</tr>\n");
	...
	printf("<table border=0 cellspacing=4 cellspadding=0>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='perfItem'><a href='%s?type=%d' class='perfItem'>%s:</a></td>", EXTINFO_CGI, DISPLAY_PERFORMANCE,_("Service Check Execution Time"));
	printf("<td valign=top class='perfValue' nowrap><a href='%s?type=%d' class='perfValue'>%.2f / %.2f / %.3f %s </a></td>\n", EXTINFO_CGI, DISPLAY_PERFORMANCE, min_service_execution_time, max_service_execution_time, average_service_execution_time,_("sec"));
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='perfItem'><a href='%s?type=%d' class='perfItem'>%s:</a></td>", EXTINFO_CGI, DISPLAY_PERFORMANCE,_("Service Check Latency"));

	printf("<td valign=top class='perfValue' nowrap><a href='%s?type=%d' class='perfValue'>%.2f / %.2f / %.3f %s </a></td>\n", EXTINFO_CGI, DISPLAY_PERFORMANCE, min_service_latency, max_service_latency, average_service_latency,_("sec"));
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='perfItem'><a href='%s?type=%d' class='perfItem'>%s:</a></td>", EXTINFO_CGI, DISPLAY_PERFORMANCE,_("Host Check Execution Time"));
	
	printf("<td valign=top class='perfValue' nowrap><a href='%s?type=%d' class='perfValue'>%.2f / %.2f / %.3f %s</a></td>\n", EXTINFO_CGI, DISPLAY_PERFORMANCE, min_host_execution_time, max_host_execution_time, average_host_execution_time,_("sec"));
	
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='perfItem'><a href='%s?type=%d' class='perfItem'>%s:</a></td>", EXTINFO_CGI, DISPLAY_PERFORMANCE,_("Host Check Latency"));
	
	printf("<td valign=top class='perfValue' nowrap><a href='%s?type=%d' class='perfValue'>%.2f / %.2f / %2.3f %s </a></td>\n", EXTINFO_CGI, DISPLAY_PERFORMANCE, min_host_latency, max_host_latency, average_host_latency,_("sec"));
	
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='perfItem'><a href='%s?host=all&serviceprops=%d' class='perfItem'># %s:</a></td>", STATUS_CGI, SERVICE_ACTIVE_CHECK,_("Active Host / Service Checks"));
	...
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='perfItem'><a href='%s?host=all&serviceprops=%d' class='perfItem'># %s:</a></td>", STATUS_CGI, SERVICE_PASSIVE_CHECK,_("Passive Host / Service Checks"));
	...
	printf("<tr><td colspan=1 height=20 class='outageTitle'>&nbsp;%s</td></tr>\n",_("Network Outages"));
	printf("<tr>\n");
	printf("<td class='outageHeader' width=125><a href='%s' class='outageHeader'>", OUTAGES_CGI);
	if(is_authorized_for_all_hosts(&current_authdata) == FALSE)
		printf("N/A");
	else
		printf("%d %s", total_blocking_outages,_("Outages"));
	...
	if(total_blocking_outages > 0)
		printf("<tr><td width=100%% class='outageImportantProblem'><a href='%s'>%d %s</a></td></tr>\n", OUTAGES_CGI, total_blocking_outages,_("Blocking Outages"));
	...
	*/
	...
	printf("<table border=0 cellspacing=4 cellspadding=0>\n");
	printf("<tr>\n");
	printf("<td class='healthTitle'>&nbsp;%s</td>\n",_("Network Health"));
	printf("</tr>\n");
	...
	printf("<table border=0 cellspacing=4 cellspadding=0>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='healthItem'>%s:</td>",_("Host Health"));
	...
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='healthItem'>%s:</td>",_("Service Health"));
	...
	printf("<tr><td colspan=4 height=20 class='hostTitle'>&nbsp;%s</td></tr>\n",_("Hosts"));
	printf("<tr>\n");
	printf("<td class='hostHeader' width=125><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d' class='hostHeader'>%d %s</a></td>\n", STATUS_CGI, HOST_DOWN, hosts_down,_("Down"));
	printf("<td class='hostHeader' width=125><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d' class='hostHeader'>%d %s</a></td>\n", STATUS_CGI, HOST_UNREACHABLE, hosts_unreachable,_("Unreachable"));
	printf("<td class='hostHeader' width=125><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d' class='hostHeader'>%d %s</a></td>\n", STATUS_CGI, HOST_UP, hosts_up,_("Up"));
	printf("<td class='hostHeader' width=125><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d' class='hostHeader'>%d %s</a></td>\n", STATUS_CGI, HOST_PENDING, hosts_pending,_("Pending"));
	printf("</tr>\n");
	...
	if(hosts_down_unacknowledged > 0)
		printf("<tr><td width=100%% class='hostImportantProblem'><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, HOST_DOWN, HOST_NO_SCHEDULED_DOWNTIME | HOST_STATE_UNACKNOWLEDGED | HOST_CHECKS_ENABLED, hosts_down_unacknowledged,_("Unhandled Problems"));

	if(hosts_down_scheduled > 0)
		printf("<tr><td width=100%% class='hostUnimportantProblem'><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, HOST_DOWN, HOST_SCHEDULED_DOWNTIME, hosts_down_scheduled,_("Scheduled"));

	if(hosts_down_acknowledged > 0)
		printf("<tr><td width=100%% class='hostUnimportantProblem'><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, HOST_DOWN, HOST_STATE_ACKNOWLEDGED, hosts_down_acknowledged,_("Acknowledged"));

	if(hosts_down_disabled > 0)
		printf("<tr><td width=100%% class='hostUnimportantProblem'><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, HOST_DOWN, HOST_CHECKS_DISABLED, hosts_down_disabled,_("Acknowledged"));
	...
	if(hosts_unreachable_unacknowledged > 0)
		printf("<tr><td width=100%% class='hostImportantProblem'><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, HOST_UNREACHABLE, HOST_NO_SCHEDULED_DOWNTIME | HOST_STATE_UNACKNOWLEDGED | HOST_CHECKS_ENABLED, hosts_unreachable_unacknowledged,_("Unhandled Problems"));

	if(hosts_unreachable_scheduled > 0)
		printf("<tr><td width=100%% class='hostUnimportantProblem'><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, HOST_UNREACHABLE, HOST_SCHEDULED_DOWNTIME, hosts_unreachable_scheduled,_("Scheduled"));

	if(hosts_unreachable_acknowledged > 0)
		printf("<tr><td width=100%% class='hostUnimportantProblem'><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, HOST_UNREACHABLE, HOST_STATE_ACKNOWLEDGED, hosts_unreachable_acknowledged,_("Acknowledged"));

	if(hosts_unreachable_disabled > 0)
		printf("<tr><td width=100%% class='hostUnimportantProblem'><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, HOST_UNREACHABLE, HOST_CHECKS_DISABLED, hosts_unreachable_disabled,_("Disabled"));
	...
	if(hosts_up_disabled > 0)
		printf("<tr><td width=100%% class='hostUnimportantProblem'><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, HOST_UP, HOST_CHECKS_DISABLED, hosts_up_disabled,_("Disabled"));
	...
	if(hosts_pending_disabled > 0)
		printf("<tr><td width=100%% class='hostUnimportantProblem'><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, HOST_PENDING, HOST_CHECKS_DISABLED, hosts_pending_disabled,_("Disabled"));
	...
	*/
	...
	printf("<tr><td colspan=5 height=20 class='serviceTitle'>&nbsp;%s</td></tr>\n",_("Services"));

	printf("<tr>\n");
	printf("<td class='serviceHeader' width=125><a href='%s?host=all&style=detail&servicestatustypes=%d' class='serviceHeader'>%d %s</a></td>\n", STATUS_CGI, SERVICE_CRITICAL, services_critical, _("Critical"));
	printf("<td class='serviceHeader' width=125><a href='%s?host=all&style=detail&servicestatustypes=%d' class='serviceHeader'>%d %s</a></td>\n", STATUS_CGI, SERVICE_WARNING, services_warning, _("Warning"));
	printf("<td class='serviceHeader' width=125><a href='%s?host=all&style=detail&servicestatustypes=%d' class='serviceHeader'>%d %s</a></td>\n", STATUS_CGI, SERVICE_UNKNOWN, services_unknown, _("Unknown"));
	printf("<td class='serviceHeader' width=125><a href='%s?host=all&style=detail&servicestatustypes=%d' class='serviceHeader'>%d %s</a></td>\n", STATUS_CGI, SERVICE_OK, services_ok,_("Ok"));
	printf("<td class='serviceHeader' width=125><a href='%s?host=all&style=detail&servicestatustypes=%d' class='serviceHeader'>%d %s</a></td>\n", STATUS_CGI, SERVICE_PENDING, services_pending, _("Pending"));
	printf("</tr>\n");
	...
	if(services_critical_unacknowledged > 0)
		printf("<tr><td width=100%% class='serviceImportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&hoststatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_CRITICAL, HOST_UP | HOST_PENDING, SERVICE_NO_SCHEDULED_DOWNTIME | SERVICE_STATE_UNACKNOWLEDGED | SERVICE_CHECKS_ENABLED, services_critical_unacknowledged, _("Unhandled Problems"));

	if(services_critical_host_problem > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&hoststatustypes=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_CRITICAL, HOST_DOWN | HOST_UNREACHABLE, services_critical_host_problem, _("on Problem Hosts"));

	if(services_critical_scheduled > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_CRITICAL, SERVICE_SCHEDULED_DOWNTIME, services_critical_scheduled, _("Scheduled"));

	if(services_critical_acknowledged > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_CRITICAL, SERVICE_STATE_ACKNOWLEDGED, services_critical_acknowledged, _("Acknowledged"));

	if(services_critical_disabled > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_CRITICAL, SERVICE_CHECKS_DISABLED, services_critical_disabled,_("Disabled"));
	...
	if(services_warning_unacknowledged > 0)
		printf("<tr><td width=100%% class='serviceImportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&hoststatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_WARNING, HOST_UP | HOST_PENDING, SERVICE_NO_SCHEDULED_DOWNTIME | SERVICE_STATE_UNACKNOWLEDGED | SERVICE_CHECKS_ENABLED, services_warning_unacknowledged, _("Unhandled Problems"));

	if(services_warning_host_problem > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&hoststatustypes=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_WARNING, HOST_DOWN | HOST_UNREACHABLE, services_warning_host_problem, _("on Problem Hosts"));

	if(services_warning_scheduled > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_WARNING, SERVICE_SCHEDULED_DOWNTIME, services_warning_scheduled, _("Scheduled"));

	if(services_warning_acknowledged > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_WARNING, SERVICE_STATE_ACKNOWLEDGED, services_warning_acknowledged, _("Acknowledged"));

	if(services_warning_disabled > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_WARNING, SERVICE_CHECKS_DISABLED, services_warning_disabled, _("Disabled"));
	...
	if(services_unknown_unacknowledged > 0)
		printf("<tr><td width=100%% class='serviceImportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&hoststatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_UNKNOWN, HOST_UP | HOST_PENDING, SERVICE_NO_SCHEDULED_DOWNTIME | SERVICE_STATE_UNACKNOWLEDGED | SERVICE_CHECKS_ENABLED, services_unknown_unacknowledged,_("Unhandled Problems"));

	if(services_unknown_host_problem > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&hoststatustypes=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_UNKNOWN, HOST_DOWN | HOST_UNREACHABLE, services_unknown_host_problem, _("on Problem Hosts"));

	if(services_unknown_scheduled > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_UNKNOWN, SERVICE_SCHEDULED_DOWNTIME, services_unknown_scheduled,_("Scheduled"));

	if(services_unknown_acknowledged > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_UNKNOWN, SERVICE_STATE_ACKNOWLEDGED, services_unknown_acknowledged, _("Acknowledged"));

	if(services_unknown_disabled > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_UNKNOWN, SERVICE_CHECKS_DISABLED, services_unknown_disabled, _("Disabled"));
	...
	if(services_ok_disabled > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_OK, SERVICE_CHECKS_DISABLED, services_ok_disabled,_("Disabled"));
	...
	if(services_pending_disabled > 0)
		printf("<tr><td width=100%% class='serviceUnimportantProblem'><a href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>%d %s</a></td></tr>\n", STATUS_CGI, SERVICE_PENDING, SERVICE_CHECKS_DISABLED, services_pending_disabled,_("Disabled"));
	...
	printf("<tr><td colspan=5 height=20 class='featureTitle'>&nbsp;%s</td></tr>\n",_("Monitoring Features"));

	printf("<tr>\n");
	printf("<td class='featureHeader' width=135>%s</td>\n", _("Flap Detection"));
	printf("<td class='featureHeader' width=135>%s</td>\n", _("Notifications"));
	printf("<td class='featureHeader' width=135>%s</td>\n", _("Notifications"));
	printf("<td class='featureHeader' width=135>%s</td>\n", _("Active Checks"));
	printf("<td class='featureHeader' width=135>%s</td>\n", _("Passive Checks"));
	...
	if(enable_flap_detection == TRUE) {
		...
		if(flap_disabled_services > 0)
			printf("<tr><td width=100%% class='featureItemDisabledServiceFlapDetection'><a href='%s?host=all&type=detail&serviceprops=%d'>%d %s %s %s</a></td></tr>\n", STATUS_CGI, SERVICE_FLAP_DETECTION_DISABLED, flap_disabled_services, _("Service") ,(flap_disabled_services == 1) ? "" : "s",_("Disabled"));
		else
			printf("<tr><td width=100%% class='featureItemEnabledServiceFlapDetection'>%s</td></tr>\n",_("All Services Enabled"));

		if(flapping_services > 0)
			printf("<tr><td width=100%% class='featureItemServicesFlapping'><a href='%s?host=all&type=detail&serviceprops=%d'>%d %s%s %s</a></td></tr>\n", STATUS_CGI, SERVICE_IS_FLAPPING, flapping_services, _("Service"),(flapping_services == 1) ? "" : "s",_("Flapping"));
		else
			printf("<tr><td width=100%% class='featureItemServicesNotFlapping'>%s</td></tr>\n",_("No Services Flapping"));

		if(flap_disabled_hosts > 0)
			printf("<tr><td width=100%% class='featureItemDisabledHostFlapDetection'><a href='%s?host=all&type=detail&hostprops=%d'>%d %s %s %s</a></td></tr>\n", STATUS_CGI, HOST_FLAP_DETECTION_DISABLED, flap_disabled_hosts, _("Host"),(flap_disabled_hosts == 1) ? "" : "s",_("Disabled"));
		else
			printf("<tr><td width=100%% class='featureItemEnabledHostFlapDetection'>%s</td></tr>\n",_("All Hosts Enabled"));

		if(flapping_hosts > 0)
			printf("<tr><td width=100%% class='featureItemHostsFlapping'><a href='%s?host=all&type=detail&hostprops=%d'>%d %s%s %s</a></td></tr>\n", STATUS_CGI, HOST_IS_FLAPPING, flapping_hosts, _("Host"),(flapping_hosts == 1) ? "" : "s",_("Flapping"));
		else
			printf("<tr><td width=100%% class='featureItemHostsNotFlapping'>%s</td></tr>\n",_("No Hosts Flapping"));
	...
	if(enable_notifications == TRUE) {
		...
		if(notification_disabled_services > 0)
			printf("<tr><td width=100%% class='featureItemDisabledServiceNotifications'><a href='%s?host=all&type=detail&serviceprops=%d'>%d %s%s %s</a></td></tr>\n", STATUS_CGI, SERVICE_NOTIFICATIONS_DISABLED, notification_disabled_services, _("Service"),(notification_disabled_services == 1) ? "" : "s",_("Disabled"));
		else
			printf("<tr><td width=100%% class='featureItemEnabledServiceNotifications'>%s</td></tr>\n",_("All Services Enabled"));

		if(notification_disabled_hosts > 0)
			printf("<tr><td width=100%% class='featureItemDisabledHostNotifications'><a href='%s?host=all&type=detail&hostprops=%d'>%d %s%s %s</a></td></tr>\n", STATUS_CGI, HOST_NOTIFICATIONS_DISABLED, notification_disabled_hosts, _("Host"),(notification_disabled_hosts == 1) ? "" : "s",_("Disabled"));
		else
			printf("<tr><td width=100%% class='featureItemEnabledHostNotifications'>%s</td></tr>\n",_("All Hosts Enabled"));
	...
	if(enable_event_handlers == TRUE) {
		...
		if(event_handler_disabled_services > 0)
			printf("<tr><td width=100%% class='featureItemDisabledServiceHandlers'><a href='%s?host=all&type=detail&serviceprops=%d'>%d %s%s %s</a></td></tr>\n", STATUS_CGI, SERVICE_EVENT_HANDLER_DISABLED, event_handler_disabled_services,_("Service"), (event_handler_disabled_services == 1) ? "" : "s",_("Disabled"));
		else
			printf("<tr><td width=100%% class='featureItemEnabledServiceHandlers'>%s</td></tr>\n",_("All Services Enabled"));

		if(event_handler_disabled_hosts > 0)
			printf("<tr><td width=100%% class='featureItemDisabledHostHandlers'><a href='%s?host=all&type=detail&hostprops=%d'>%d %s%s %s</a></td></tr>\n", STATUS_CGI, HOST_EVENT_HANDLER_DISABLED, event_handler_disabled_hosts, _("Host"),(event_handler_disabled_hosts == 1) ? "" : "s",_("Disabled"));
		else
			printf("<tr><td width=100%% class='featureItemEnabledHostHandlers'>%s</td></tr>\n",_("All Hosts Enabled"));
	...
	if(execute_service_checks == TRUE) {
		...
		if(active_checks_disabled_services > 0)
			printf("<tr><td width=100%% class='featureItemDisabledActiveServiceChecks'><a href='%s?host=all&type=detail&serviceprops=%d'>%d %s%s %s</a></td></tr>\n", STATUS_CGI, SERVICE_CHECKS_DISABLED, active_checks_disabled_services,_("Service"), (active_checks_disabled_services == 1) ? "" : "s",_("Disabled"));
		else
			printf("<tr><td width=100%% class='featureItemEnabledActiveServiceChecks'>%s</td></tr>\n",_("All Services Enabled"));

		if(active_checks_disabled_hosts > 0)
			printf("<tr><td width=100%% class='featureItemDisabledActiveHostChecks'><a href='%s?host=all&type=detail&hostprops=%d'>%d %s%s %s</a></td></tr>\n", STATUS_CGI, HOST_CHECKS_DISABLED, active_checks_disabled_hosts, _("Host"),(active_checks_disabled_hosts == 1) ? "" : "s",_("Disabled"));
		else
			printf("<tr><td width=100%% class='featureItemEnabledActiveHostChecks'>%s</td></tr>\n",_("All Hosts Enabled"));
	...
	if(accept_passive_service_checks == TRUE) {
		...
		if(passive_checks_disabled_services > 0)
			printf("<tr><td width=100%% class='featureItemDisabledPassiveServiceChecks'><a href='%s?host=all&type=detail&serviceprops=%d'>%d %s%s %s</a></td></tr>\n", STATUS_CGI, SERVICE_PASSIVE_CHECKS_DISABLED, passive_checks_disabled_services,_("Service"), (passive_checks_disabled_services == 1) ? "" : "s",_("Disabled"));
		else
			printf("<tr><td width=100%% class='featureItemEnabledPassiveServiceChecks'>%s</td></tr>\n",_("All Services Enabled"));

		if(passive_checks_disabled_hosts > 0)
			printf("<tr><td width=100%% class='featureItemDisabledPassiveHostChecks'><a href='%s?host=all&type=detail&hostprops=%d'>%d %s%s %s</a></td></tr>\n", STATUS_CGI, HOST_PASSIVE_CHECKS_DISABLED, passive_checks_disabled_hosts, _("Host") ,(passive_checks_disabled_hosts == 1) ? "" : "s",_("Disabled"));
		else
			printf("<tr><td width=100%% class='featureItemEnabledPassiveHostChecks'>%s</td></tr>\n",_("All Hosts Enabled"));

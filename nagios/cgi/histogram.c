...
int main(int argc, char **argv) {
	...
	if(mode == CREATE_HTML && display_header == TRUE) {
		...
		if(display_type != DISPLAY_NO_HISTOGRAM && input_type == GET_INPUT_NONE) {
			...
			if(display_type == DISPLAY_HOST_HISTOGRAM) {
#ifdef USE_TRENDS
				printf("<a href='%s?host=%s&t1=%lu&t2=%lu&assumestateretention=%s'>%s</a><BR>\n", TRENDS_CGI, url_encode(host_name), t1, t2, (assume_state_retention == TRUE) ? "yes" : "no",_("View Trends For This Host"));
#endif
				printf("<a href='%s?host=%s&t1=%lu&t2=%lu&assumestateretention=%s&show_log_entries'>%s</a><BR>\n", AVAIL_CGI, url_encode(host_name), t1, t2, (assume_state_retention == TRUE) ? "yes" : "no",_("View Availability Report For This Host"));
				printf("<a href='%s?host=%s'>%s</a><BR>\n", STATUS_CGI, url_encode(host_name),_("View Status Detail For This Host"));
				printf("<a href='%s?host=%s'>%s</a><BR>\n", HISTORY_CGI, url_encode(host_name),_("View History For This Host"));
...
#endif
				printf("&service=%s&t1=%lu&t2=%lu&assumestateretention=%s'>%s</a><BR>\n", url_encode(svc_description), t1, t2, (assume_state_retention == TRUE) ? "yes" : "no",_("View Trends For This Service"));
				printf("<a href='%s?host=%s", AVAIL_CGI, url_encode(host_name));
				printf("&service=%s&t1=%lu&t2=%lu&assumestateretention=%s&show_log_entries'>%s</a><BR>\n", url_encode(svc_description), t1, t2, (assume_state_retention == TRUE) ? "yes" : "no",_("View Availability Report For This Service"));
				printf("<A HREF='%s?host=%s&", HISTORY_CGI, url_encode(host_name));
				printf("service=%s'>%s</A><BR>\n", url_encode(svc_description),_("View History For This Service"));
		...
		if(display_type != DISPLAY_NO_HISTOGRAM && input_type == GET_INPUT_NONE) {
			...
			printf("<tr><td CLASS='optBoxItem' valign=top align=left>%s:</td><td CLASS='optBoxItem' valign=top align=left>%s:</td></tr>\n",_("Breakdown type"),_("Initial states logged"));
			printf("<tr><td CLASS='optBoxItem' valign=top align=left>\n");
			printf("<select name='breakdown'>\n");
			printf("<option value=monthly %s>%s\n", (breakdown_type == BREAKDOWN_MONTHLY) ? "SELECTED" : "",_("Month"));
			printf("<option value=dayofmonth %s>%s\n", (breakdown_type == BREAKDOWN_DAY_OF_MONTH) ? "SELECTED" : "",_("Day of the Month"));
			printf("<option value=dayofweek %s>%s\n", (breakdown_type == BREAKDOWN_DAY_OF_WEEK) ? "SELECTED" : "",_("Day of the Week"));
			printf("<option value=hourly %s>%s\n", (breakdown_type == BREAKDOWN_HOURLY) ? "SELECTED" : "",_("Hour of the Day"));
			printf("</select>\n");
			printf("</td><td CLASS='optBoxItem' valign=top align=left>\n");
			...
			printf("<tr><td CLASS='optBoxItem' valign=top align=left>%s:</td><td CLASS='optBoxItem' valign=top align=left>%s:</td></tr>\n",_("Events to graph"),_("Ignore repeated states"));
			printf("<tr><td CLASS='optBoxItem' valign=top align=left>\n");
			printf("<select name='graphevents'>\n");
			if(display_type == DISPLAY_HOST_HISTOGRAM) {
				printf("<option value=%d %s>%s\n", GRAPH_HOST_ALL, (graph_events == GRAPH_HOST_ALL) ? "SELECTED" : "",_("All host events"));
				printf("<option value=%d %s>%s\n", GRAPH_HOST_PROBLEMS, (graph_events == GRAPH_HOST_PROBLEMS) ? "SELECTED" : "",_("Host problem events"));
				printf("<option value=%d %s>%s\n", GRAPH_HOST_UP, (graph_events == GRAPH_HOST_UP) ? "SELECTED" : "",_("Host up events"));
				printf("<option value=%d %s>%s\n", GRAPH_HOST_DOWN, (graph_events == GRAPH_HOST_DOWN) ? "SELECTED" : "",_("Host down events"));
				printf("<option value=%d %s>%s\n", GRAPH_HOST_UNREACHABLE, (graph_events == GRAPH_HOST_UNREACHABLE) ? "SELECTED" : "",_("Host unreachable events"));
				}
			else {
				printf("<option value=%d %s>%s\n", GRAPH_SERVICE_ALL, (graph_events == GRAPH_SERVICE_ALL) ? "SELECTED" : "",_("All service events"));
				printf("<option value=%d %s>%s\n", GRAPH_SERVICE_PROBLEMS, (graph_events == GRAPH_SERVICE_PROBLEMS) ? "SELECTED" : "",_("Service problem events"));
				printf("<option value=%d %s>%s\n", GRAPH_SERVICE_OK, (graph_events == GRAPH_SERVICE_OK) ? "SELECTED" : "",_("Service ok events"));
				printf("<option value=%d %s>%s\n", GRAPH_SERVICE_WARNING, (graph_events == GRAPH_SERVICE_WARNING) ? "SELECTED" : "",_("Service warning events"));
				printf("<option value=%d %s>%s\n", GRAPH_SERVICE_UNKNOWN, (graph_events == GRAPH_SERVICE_UNKNOWN) ? "SELECTED" : "",_("Service unknown events"));
				printf("<option value=%d %s>%s\n", GRAPH_SERVICE_CRITICAL, (graph_events == GRAPH_SERVICE_CRITICAL) ? "SELECTED" : "",_("Service critical events"));
				}
			printf("</select>\n");
			printf("</td><td CLASS='optBoxItem' valign=top align=left>\n");
			...
			printf("<tr><td CLASS='optBoxItem' valign=top align=left>%s:</td><td CLASS='optBoxItem' valign=top align=left></td></tr>\n",_("State types to graph"));
			printf("<tr><td CLASS='optBoxItem' valign=top align=left>\n");
			printf("<select name='graphstatetypes'>\n");
			printf("<option value=%d %s>%s\n", GRAPH_HARD_STATETYPES, (graph_statetypes == GRAPH_HARD_STATETYPES) ? "SELECTED" : "",_("Hard states"));
			printf("<option value=%d %s>%s\n", GRAPH_SOFT_STATETYPES, (graph_statetypes == GRAPH_SOFT_STATETYPES) ? "SELECTED" : "",_("Soft states"));
			printf("<option value=%d %s>%s\n", GRAPH_ALL_STATETYPES, (graph_statetypes == GRAPH_ALL_STATETYPES) ? "SELECTED" : "",_("Hard and soft states"));
			printf("</select>\n");
			printf("</td><td CLASS='optBoxItem' valign=top align=left>\n");
	...
	if(is_authorized == FALSE) {
		...
		if(mode == CREATE_HTML)
			printf("<P><DIV ALIGN=CENTER CLASS='errorMessage'>%s %s...</DIV></P>\n", _("It appears as though you are not authorized to view information for the specified"),(display_type == DISPLAY_HOST_HISTOGRAM) ? _("host") : _("service"));
...
#ifdef DEBUG
			printf("%s\n",_("Done reading archived state data."));
#endif
	...
	if(display_type == DISPLAY_NO_HISTOGRAM || input_type != GET_INPUT_NONE) {
		...
		/* ask the user for report range and options */
			...
			printf("<tr><td class='reportSelectSubTitle' align=right>%s:</td>\n",_("Statistics Breakdown"));
			printf("<td class='reportSelectItem'>\n");
			printf("<select name='breakdown'>\n");
			printf("<option value=monthly>%s\n",_("Month"));
			printf("<option value=dayofmonth SELECTED>%s\n",_("Day of the Month"));
			printf("<option value=dayofweek>%s\n",_("Day of the Week"));
			printf("<option value=hourly>%s\n",_("Hour of the Day"));
			printf("</select>\n");
			printf("</td></tr>\n");
			...
			printf("<td class='reportSelectItem'>\n");
			printf("<select name='graphstatetypes'>\n");
			printf("<option value=%d>%s\n", GRAPH_HARD_STATETYPES,_("Hard states"));
			printf("<option value=%d>%s\n", GRAPH_SOFT_STATETYPES,_("Soft states"));
			printf("<option value=%d SELECTED>%s\n", GRAPH_ALL_STATETYPES,_("Hard and soft states"));
			printf("</select>\n");
			printf("</td></tr>\n");
...
#ifdef DEBUG
	printf("%s...\n",_("Starting to draw Y grid lines"));
#endif
...
#ifdef DEBUG
	printf("%s (total_buckets=%d)...\n", _("About to starting graphing"),total_buckets);
#endif
...
#ifdef DEBUG
		printf("%s...\n",_("Done graphing HOST UP states"));
#endif
...
#ifdef DEBUG
		printf("%s...\n",_("Done graphing HOST DOWN states"));
#endif
...
#ifdef DEBUG
		printf("%s...\n",_("Done graphing HOST UNREACHABLE states"));
#endif
...
#ifdef DEBUG2
		printf("%s: %d\n", _("Recording a program start"),state_type);
#endif
...
#ifdef DEBUG2
		printf("%s...\n",_("Skipping state (not a new state)"));
#endif
		return;
		}
